...
document.querySelector('nav a:first-child').textContent = siteContent['nav']['nav-item-1']
...
document.querySelector('nav a:last-child').textContent = siteContent['nav']['nav-item-6']
...
const newFAQLink = document.createElement('a')
newFAQLink.textContent = 'FAQ'

parentElement.prepend(newHomeLink)
parentElement.appendChild(newFAQLink)
